    ...
    >
      ...
      <div className="absolute inset-0 rounded-[16px] overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, #1E3A8A, #3B82F6, #93C5FD, #3B82F6, #1E3A8A)",
          }}
          animate={{ rotate: 360 }}
      ...
      <div className="relative h-[38px] w-[38px] rounded-[12px] bg-surface flex items-center justify-center overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)]">
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, #3B82F6 0%, #1E3A8A 50%, #3B82F6 100%)",
